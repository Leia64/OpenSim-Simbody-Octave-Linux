...
executable_path = os.path.join(build_dir, "TrackSim_2_kneeCont_KCFasinput")
generated_py = os.path.join(build_dir, "foo.py")
generated_c = os.path.join(script_dir, "foo_jac.c")

lib_target_name = "TrackSim_2_kneeCont_KCFasinput.so"
...
try:
    ...
    print(f"Error during the execution of TrackSim_2_kneeCont_KCFasinput:\n{e.stderr}")
    sys.exit(1)
...
if args.clean:
    ...
    print("\nAll files kept (foo.py, foo_jac.c, and TrackSim_2_kneeCont_KCFasinput.so).")